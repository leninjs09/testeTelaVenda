...
begin
  ...
  begin
    FPedidosVenda.edCodCliente.Text := FPedidosVendaModel.tbPedidoProdutosCodigoCliente.AsString;
    FPedidosVenda.lbTotal.Caption := FormatFloat('R$ #,##0.00', FPedidosVendaModel.CalcularTotalPedido);
  end;
...
begin
  ...
  if FPedidosVendaModel.GravarPedido then
    limparTela;
...
begin
  ...
  if not FPedidosVendaModel.tbPedidoProdutos.IsEmpty then
    FPedidosVendaModel.tbPedidoProdutos.EmptyDataSet;
